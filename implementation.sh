...
sudo mysql -e "UPDATE mysql.user SET Password=PASSWORD('computersecurity') WHERE User='root';FLUSH PRIVILEGES;"
...
sudo htpasswd -b -c /etc/apache2/.htpasswd company security
